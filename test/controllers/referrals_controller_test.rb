...
class ReferralsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create referral" do
    assert_difference('Referral.count') do
      post referrals_url, params: { referral: { email: @referral.email, employee_id: @referral.employee_id, first_name: @referral.first_name, last_name: @referral.last_name, phone_number: @referral.phone_number, position_id: @referral.position_id } }
    end
  ...
  test "should update referral" do
    patch referral_url(@referral), params: { referral: { email: @referral.email, employee_id: @referral.employee_id, first_name: @referral.first_name, last_name: @referral.last_name, phone_number: @referral.phone_number, position_id: @referral.position_id } }
