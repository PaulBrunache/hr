...
class JobPostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_posting" do
    assert_difference('JobPosting.count') do
      post job_postings_url, params: { job_posting: { description: @job_posting.description, name: @job_posting.name } }
    end
  ...
  test "should update job_posting" do
    patch job_posting_url(@job_posting), params: { job_posting: { description: @job_posting.description, name: @job_posting.name } }
